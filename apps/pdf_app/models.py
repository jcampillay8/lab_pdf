...
class User(models.Model):
    ...
    last_name = models.CharField(max_length=255, default="", editable=False)
    monto_i = models.CharField(max_length=255)
    num_pa = models.CharField(max_length=255)
    domic = models.CharField(max_length=255)
    num_op = models.CharField(max_length=255)
    fecha_suscr = models.CharField(max_length=10)
